...
@interface SEBInfiniteScrollView() <UIScrollViewDelegate>
@property (weak, nonatomic) UIScrollView *scrollView;
@property (weak, nonatomic) NSTimer *timer;
@end

@implementation SEBInfiniteScrollView
...
- (void)startTimer
{
    ...
    NSTimer *timer = [NSTimer scheduledTimerWithTimeInterval:self.delayTime target:self selector:@selector(next) userInfo:nil repeats:YES];
